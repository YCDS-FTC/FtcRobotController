...
@Autonomous(name="12 close blue", group = "examples")
public class ball12_blue extends OpMode {
    ...
    private final Pose emptyGate = new Pose(13.841155234657041, 74.37545126353788, Math.toRadians(90));
