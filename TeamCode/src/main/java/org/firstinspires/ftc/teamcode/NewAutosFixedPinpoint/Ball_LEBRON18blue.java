...
public class Ball_LEBRON18blue extends OpMode {
    ...
    private final Pose scorePose1 = new Pose(54.52057761732854, 75.81588447653431, Math.toRadians(180));
    ...
    private final Pose gatepickup = new Pose(11.528792569659443, 60.35448916408669, Math.toRadians(150));
    ...
    private final Pose spike1 = new Pose(19.555956678700376, 84.22382671480143, Math.toRadians(180));

    private final Pose spike3 = new Pose(16.08664259927798, 34.83032490974729, Math.toRadians(180));

    private final Pose spike3control = new Pose(65.98142414860682, 31.761609907120746);
