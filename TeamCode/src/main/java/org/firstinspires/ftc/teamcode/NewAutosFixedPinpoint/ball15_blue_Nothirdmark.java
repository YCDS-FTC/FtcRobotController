...
@Autonomous(name="15 close blue-without third spike mark", group = "examples")
public class ball15_blue_Nothirdmark extends OpMode {
    ...
    private final Pose scorePose2 = new Pose(58.62538699690402, 108.55727554179568, Math.toRadians(210));
    ...
    public void buildPaths(){
        ...
        score3.setBrakingStrength(6);
        score3.setBrakingStart(1.5);
        ...
        score4 = new Path(new BezierCurve(gatepick, score3control, scorePose1));
        score4.setLinearHeadingInterpolation(gatepick.getHeading(), scorePose1.getHeading(), 0.8);
        score4.setBrakingStrength(6);
        score4.setBrakingStart(1.5);
