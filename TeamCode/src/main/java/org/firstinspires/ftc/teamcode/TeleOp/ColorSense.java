...
@Config
@TeleOp(name = "ColoeSenseigiug", group = "Linear OpMode")
...
//                rx -= autoSteer;
        ...
        angleWant = Math.toDegrees(Math.atan2(144 - (robot.pinpoint.getPosY(DistanceUnit.INCH) + robot.pinpoint.getVelY(DistanceUnit.INCH)*1), 138 - (robot.pinpoint.getPosX(DistanceUnit.INCH) + robot.pinpoint.getVelX(DistanceUnit.INCH)*1))) - 180;
